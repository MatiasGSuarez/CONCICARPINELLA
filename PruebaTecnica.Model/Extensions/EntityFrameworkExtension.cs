...
namespace PruebaTecnica.Model.Extensions
{
    public static class EntityFrameworkExtension
    {
        ...
        public static IQueryable<TSource> Compare<TSource, TValue>(this IQueryable<TSource> source, Expression<Func<TSource, TValue>> selector,TValue value, Comparison comparison)
        {
